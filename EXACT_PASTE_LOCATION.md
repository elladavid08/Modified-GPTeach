# Exact Location to Paste Your Scenarios

## 📁 File to Edit
```
src/config/scenarios/geometry_scenarios.js
```
...
const scenarios = [
	...
	// 👇 PASTE YOUR 4 NEW SCENARIOS RIGHT HERE, AFTER THIS LINE 👇
...
### AFTER (with your PCK scenarios added):
...
const scenarios = [
	...
	// ← Note: NO comma after last scenario!
];

export default { scenarios };
```

## ⚠️ Critical: Comma Rules

### ✅ Correct:
```javascript
},  // ← Comma after every scenario
{
  // next scenario
},  // ← Comma
{
...
{
  // ERROR: JavaScript will break
```

## 🎯 Quick Steps

1. **Open** `src/config/scenarios/geometry_scenarios.js`
2. **Find** the line with the last existing scenario (line ~22)
3. **Make sure** there's a comma after its closing `}`
4. **Paste** your 4 new scenarios after that comma
5. **Verify** NO comma after the very last scenario
6. **Save** the file

## ✅ Checklist

- [ ] File opened: `src/config/scenarios/geometry_scenarios.js`
- [ ] Found the scenarios array
- [ ] Comma after last existing scenario
- [ ] Pasted 4 new PCK scenarios
- [ ] No comma after the final scenario
- [ ] Saved the file
- [ ] Ready to test!
...
Look for any errors in the console. If you see syntax errors, check your commas!

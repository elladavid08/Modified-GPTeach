		...
		<div className="container">
			...
			<div className="d-flex flex-column">
				<div className="textPage">
					...
					<p style={{fontSize:"18pt"}}>Your task is to go through this interactive tutor training tool, responding to the best of your abilities. This isn't a test but rather a chance for you to get practice teaching. <b>You will go through three tutoring sessions, with two middle-school students in each, where you will assume the role of a geometry tutor. Your job is to interact with the students and help them with geometry concepts while paying attention to the learning goals.</b> Once you feel you've reached the end of a session, you may move on to the next.  Please note: you may not go back to any previous ones. </p>
